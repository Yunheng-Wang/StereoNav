...
if __name__=="__main__":
  ...
  parser.add_argument('--ckpt_dir', default="/home/CONNECT/yfang870/yunhengwang/StereoVLN/model/base/FoundationStereo/checkpoints/23-51-11/model_best_bp2.pth", type=str, help='pretrained model path')
