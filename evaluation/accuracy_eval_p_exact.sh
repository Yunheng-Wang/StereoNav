#!/bin/bash
# Distributed evaluation script for StereoVLN using exact action prediction.
...
# Usage: bash evaluation/accuracy_eval_p_exact.sh
...
CMD="torchrun --nproc_per_node=8 --master_port=$MASTER_PORT evaluation/accuracy_eval_p_exact.py \
    --server_urls $SERVER_URLS \
