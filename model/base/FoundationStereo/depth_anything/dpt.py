...
class DPT_DINOv2(nn.Module):
    def __init__(self, encoder='vitl', features=256, out_channels=[256, 512, 1024, 1024], use_bn=False, use_clstoken=False, pretrained_dino=False):
        ...
        self.pretrained = torch.hub.load(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'dinov2'), 'dinov2_{:}14'.format(encoder), pretrained=pretrained_dino, source='local')
